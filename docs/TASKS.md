...
| ID | Description | Status | Expected Files | Dependencies | Definition of Done |
|---|---|---|---|---|---|
| CM001 | Set up global design tokens and CSS variables | 🔲 | `styles/globals.css` | CM0S1 | All brand tokens (`--accent-emerald`, `--bg`, `--text`, etc.) defined and matching prototype |
