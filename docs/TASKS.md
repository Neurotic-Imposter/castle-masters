...
| CM028 | Build Team page | 🔲 | `app/src/app/team/page.tsx`, `app/src/lib/content/team.ts` | CM027 | Placeholder cards only; no invented names, FIDE ratings, or bios; Server Component only; build and lint passed |
| CM029 | Build Contact page | 🔲 | `app/src/app/contact/page.tsx`, `app/src/lib/content/contact.ts` | CM028 | Inquiry form (Client Component); Book Free Trial section; placeholder contact info; no invented addresses or phone numbers; build and lint passed |
| CM030 | Responsive audit — all inner pages | 🔲 | — | CM024–CM029 | No overflow at 375px, 768px, 1280px on all pages; all interactions functional on mobile |
